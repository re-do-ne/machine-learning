# In this script we'll try to to use a q-learning table to keep a pole in an upright position
...
class QCartPoleSolver:
    def __init__(self, buckets=(1, 1, 6, 12,), n_episodes=1000, n_win_ticks=495, min_alpha=0.1, min_epsilon=0.1,
    ...
    def run(self):
        scores = deque(maxlen=self.n_episodes)
